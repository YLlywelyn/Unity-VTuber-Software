...
public class TTSSetupEditor : Editor
{
    ...
    private void OnEnable()
    {
        ...
        bannerTexture = AssetDatabase.LoadAssetAtPath<Texture2D>("Assets/OpenAI/Editor/banner.png");
    }
    ...
    private void AddOpenAIPrefab()
    {
        ...
        GameObject prefab = AssetDatabase.LoadAssetAtPath<GameObject>("Assets/OpenAI/Prefabs/Core/OpenAI.prefab");
        if (prefab)
        {
    ...
    {
        GameObject prefab = AssetDatabase.LoadAssetAtPath<GameObject>("Assets/OpenAI/Prefabs/Core/TTSManager.prefab");
